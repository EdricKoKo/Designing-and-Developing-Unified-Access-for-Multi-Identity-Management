    ...
    return (
        <>
            <Navbar bg="primary" variant="dark" className="navbarStyle">
                <a className="navbar-brand" href="/" style={{display:'flex',alignItems:'center',gap:12}}>
                    <img src="/tasks-logo.svg" alt="Tasks Logo" style={{height:32}} />
                    <span style={{fontWeight:'bold',fontSize:22}}>Tasks Management</span>
                </a>
                <AuthenticatedTemplate>
                    <div className="collapse navbar-collapse justify-content-end">
                        ...
                        <DropdownButton
                            variant="warning"
                            drop="start"
                            title={activeAccount && activeAccount.idTokenClaims? activeAccount.idTokenClaims.given_name : 'Unknown'}
                        >
